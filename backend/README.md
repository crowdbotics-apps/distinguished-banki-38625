...
## Project Structure
    ...
    ├── distinguished_banki_38625  # Django project configurations
...
1. Clone this repo and `cd distinguished_banki_38625`
...
2. Clone this repo and `cd distinguished_banki_38625`
