"""
Django settings for distinguished_banki_38625 project.
...
ROOT_URLCONF = 'distinguished_banki_38625.urls'
...
WSGI_APPLICATION = 'distinguished_banki_38625.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "distinguished_banki_38625 API",
    "DESCRIPTION": "API documentation for distinguished_banki_38625 App",
    "VERSION": "v1",
}
